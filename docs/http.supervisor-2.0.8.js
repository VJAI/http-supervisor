  ...
  createClass_default()(HttpSupervisor, [{
    ...
    value: function init() {
      ...
      var _storedConfig$config = _objectSpread(_objectSpread({}, storedConfig), config),
          ...
          alertOnExceedQuota = _storedConfig$config.alertOnExceedQuota,
          quota = _storedConfig$config.quota,
          groupBy = _storedConfig$config.groupBy,
          sortBy = _storedConfig$config.sortBy,
          usePerformance = _storedConfig$config.usePerformance,
          monkeyPatchFetch = _storedConfig$config.monkeyPatchFetch,
          loadChart = _storedConfig$config.loadChart,
          keyboardEvents = _storedConfig$config.keyboardEvents,
          watches = _storedConfig$config.watches;
...
var http_supervisor_widget_HtmlSupervisorWidgetElement = /*#__PURE__*/function (_HTMLElement) {
  ...
  createClass_default()(HtmlSupervisorWidgetElement, [{
    ...
    value: function setState(_ref2) {
      ...
      Array.isArray(domains) && (this._includeTextbox.value = domains.join(','));
